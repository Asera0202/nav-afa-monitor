...
async function main() {
    ...
    try {
        ...
        console.error("   HIBA a hitelesítésnél:", err.message);
        console.error("   Ellenőrizd a .env fájlban a NAV_LOGIN / NAV_PASSWORD / NAV_SIGNING_KEY / NAV_EXCHANGE_KEY / NAV_TAX_NUMBER értékeket.");
        process.exit(1);
    }
